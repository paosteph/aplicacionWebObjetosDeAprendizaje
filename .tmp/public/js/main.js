$(document).ready(function(){
    ...
    $('.search-book-button').click(function(e){
        ...
        swal({
           title: "¿Qué objeto de aprendizaje estás buscando?",
           text: "Por favor escribe el nombre del objeto de aprendizaje",
           type: "input",   
           showCancelButton: true,
           closeOnConfirm: false,
           animation: "slide-from-top",
           ...
           inputPlaceholder: "Escribe aquí el nombre de objeto de aprendizaje" }, 
      function(inputValue){
           if (inputValue === false) return false;  

           if (inputValue === "") {
               swal.showInputError("Debes escribir el nombre del objeto de aprendizaje");     
               return false;   
           } 
